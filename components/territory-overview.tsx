...
export const TerritoryOverview = forwardRef<{ refetch: () => void }, {}>(
  (props, ref) => {
    ...
    const [territoryToDelete, setTerritoryToDelete] =
      useState<Territory | null>(null);
    ...
    const filteredTerritories = territories.filter((territory) => {
      const matchesSearch =
        ...
        territory.assignedAgentId?.name
          .toLowerCase()
          .includes(searchTerm.toLowerCase());
      const matchesStatus =
        statusFilter === "all" || territory.status === statusFilter;
      const matchesTeam =
        teamFilter === "all" || territory.teamId?.name === teamFilter;
    ...
    const handleSeeMembers = async () => {
      ...
      const teamId =
        selectedTerritory.teamId?._id ||
        selectedTerritory.currentAssignment?.teamId?._id;
      if (!teamId) return;
     ...
     const confirmDelete = async (e?: React.MouseEvent) => {
       ...
       try {
         const response = await apiInstance.delete(
           `/zones/delete/${territoryToDelete._id}`
         );

         if (response.data.success) {
           toast.success(
             response.data.message || "Territory deleted successfully"
           );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="border-gray-200 shadow-sm">
            ...
            <CardContent>
              ...
              <div className="text-xs text-gray-500 mt-1">
                {stats.activeTerritories} active,{" "}
                {stats.scheduledTerritories || 0} scheduled,{" "}
                {stats.draftTerritories || 0} draft,{" "}
                {stats.completedTerritories || 0} completed
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-gray-200 shadow-sm">
            ...
            <CardContent>
              ...
              <div className="text-xs text-gray-500 mt-1">
                {stats.topPerformingTerritory?.name} leads at{" "}
                {stats.topPerformingTerritory?.completionRate}%
              </div>
            </CardContent>
          </Card>
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="max-w-xs">
                        Counts territory creations, updates, and recent
                        assignments in the last 24 hours
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredTerritories.map((territory) => (
                    <TableRow
                      key={territory._id}
                      className="border-b border-gray-200 hover:bg-gray-50 h-20"
                    >
                        ...
                        {territory.currentAssignment?.agentId ? (
                          <div className="space-y-1">
                            <div className="flex items-center space-x-2">
                              ...
                              <div className="min-w-0 flex-1">
                                <p className="font-medium text-gray-900 truncate">
                                  {territory.currentAssignment.agentId.name}
                                </p>
                                <p className="text-xs text-gray-500 truncate">
                                  {territory.currentAssignment.agentId.email}
                                </p>
                              </div>
                            </div>
                          </div>
                      ...
                      <TableCell className="align-top">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              onClick={() => handleViewDetails(territory)}
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                router.push(`/territory-map/${territory._id}`)
                              }
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                router.push(
                                  `/territory-map-view/${territory._id}`
                                )
                              }
                            >
                ...
                <Card className="border-gray-200">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">
                        {formatDate(selectedTerritory.createdAt)}
                      </span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-gray-200">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">
                        {selectedTerritory.assignedAgentId
                          ? selectedTerritory.assignedAgentId.name
                          : selectedTerritory.currentAssignment?.teamId
                          ? "Team Assignment"
                          : "Unassigned"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">
                        {selectedTerritory.assignedAgentId
                          ? selectedTerritory.assignedAgentId.email
                          : selectedTerritory.currentAssignment?.teamId
                          ? "Team Assignment"
                          : "N/A"}
                      </span>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">
                        {selectedTerritory.teamId
                          ? selectedTerritory.teamId.name
                          : selectedTerritory.currentAssignment?.teamId
                          ? selectedTerritory.currentAssignment.teamId.name
                          : "No team assigned"}
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="text-center p-4 bg-green-50 rounded-lg">
                        <div className="text-xl font-bold text-green-600">
                          {selectedTerritory.totalResidents}
                        </div>
                      ...
                      <div className="text-center p-4 bg-blue-50 rounded-lg">
                        <div className="text-xl font-bold text-blue-600">
                          {selectedTerritory.activeResidents}
                        </div>
                        <div className="text-xs text-gray-600">
                          Active Residents
                        </div>
                      ...
                      <div className="text-center p-4 bg-purple-50 rounded-lg">
                        <div
                          className={`text-xl font-bold ${getCompletionRateColor(
                            selectedTerritory.completionRate || 0
                          )}`}
                        >
                      ...
                      <div className="text-center p-4 bg-orange-50 rounded-lg">
                        <div className="text-xl font-bold text-orange-600">
                          {selectedTerritory.averageKnocks}
                        </div>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            {formatDate(
                              selectedTerritory.lastActivity ||
                                selectedTerritory.updatedAt
                            )}
                          </p>
                        </div>
                      </div>
